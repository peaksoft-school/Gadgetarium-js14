    ...
    >
      ...
      {faqs.map((faq, index) => (
        ...
        >
          ...
          <AccordionDetails>
            <StyledLorem>{faq.answer}</StyledLorem>
          </AccordionDetails>
        </StyledAccordion>
      ))}
    </div>
