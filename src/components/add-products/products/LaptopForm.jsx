...
const schema = yup.object().shape({
  ...
  ram: yup.string().required("Выберите оперативную память"),
  storageType: yup.string().required("Выберите тип хранения"),
  dataDropzone: yup
    .array()
  ...
  return (
    <form onSubmit={handleSubmit(onSubmit)}>
      <Box sx={{ width: "400px" }}>
        ...
        <FormControl fullWidth sx={{ mb: 2 }}>
          <Typography variant="subtitle1">Тип хранения</Typography>
          <Select
          ...
          >
            <MenuItem value="" disabled>
              <span style={{ color: "#A9A9A9" }}>Выберите тип хранения</span>
            </MenuItem>
          ...
          {errors.storageType && (
            <p style={{ color: "red" }}>{errors.storageType.message}</p>
          )}
        </FormControl>
      </Box>
